...
% Resources
\Resources{2} {-}
\Resources{3} {We do not have an overview over the complete system landscape (including CI/CD, monitoring etc.)}
...
\Resources{8} {We don't prevent deploying applications with to many capabilities.}
\Resources{9} {Our whole system can be disturbed by a single rogue service.}
\Resources{10}{We don't control ingress traffic.}
\Resources{J} {We don't control egress traffic.}
\Resources{Q} {Our production environment is connected to staging, either directly or indirectly (e.g. via CI/CD).}
